        ...
        >
          ...
          <Box component='nav'>
            <List sx={{ py:'0' }}>
              ...
              {/*{IsOpenLights  && (location.pathname === PATH.lightsPage)  ? (*/}
                {isOpenLights && isLightsPage(location.pathname) ? (
              <List sx={{ paddingTop: '0', paddingBottom: '0' }}>
                <ListItem disablePadding onClick={handleDropdownToggle}>
                  <ListItemButton>
                    <ListItemText sx={{ paddingLeft: '10px' }}></ListItemText>
                    {dropdownOpen ? <ExpandLess /> : <ExpandMore />}
                  </ListItemButton>
                </ListItem>
                <List
                    ...
                    <Box component='nav'>
                      <List sx={{ paddingTop: '0', paddingBottom: '0' }}>
                        {SIDEBARROOMS?.map((elem) => (
                          ...
                          >
                            <ListItemButton>
                              <ListItemText sx={{pl:'15px'}}>{elem.name}</ListItemText>
                            </ListItemButton>
                          </ListItem>
                        ))}
                      </List>
