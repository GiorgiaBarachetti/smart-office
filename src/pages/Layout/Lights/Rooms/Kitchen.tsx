...
import background from '../../../../img/stanzePages/kitchen.jpg'
import { SHADOWSTYLE } from '../../../../utils/const/Const';
import ChartPage from '../../../../components/Chart/ChartPage';
import SwitchComponent from '../../../../components/Switch/Switch';

//<Box component='div' display={'flex'} flexDirection={'column'} justifyContent={'center'} sx={{textAlign:'center', padding: '10px', borderRadius: '6px', bgcolor: 'white', mx: 'auto', my: '30px', width:'70px', ...SHADOWSTYLE }}> ID {id}</Box>
const Kitchen = () => {
  const id = 4;
